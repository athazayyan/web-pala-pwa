        ...
        <div className="space-y-5">
          ...
          <div className="bg-surface-container-low rounded-xl p-4">
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="font-label-caps text-[10px] text-secondary border border-secondary/30 px-2 py-0.5 rounded-full">{product.grade}</span>
              <span className="font-label-caps text-[10px] text-on-surface-variant">• Kemurnian: {product.purity}</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="p-8 border-r border-on-primary/10">
            ...
            <div className="space-y-2 text-xs font-mono">
              ...
              <div className="flex justify-between">
                <span className="text-on-primary/50">KEMURNIAN</span>
                <span className="text-secondary-fixed font-bold">{product.purity} Myristicin</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="p-8 border-r border-on-primary/10">
            ...
            <div className="space-y-3 text-xs font-mono bg-on-primary/5 p-4 rounded-xl">
              ...
              <div className="flex justify-between">
                <span className="text-on-primary/50">GRADE</span>
                <span className="text-on-primary">{product.grade}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-on-primary/50">PANEN TERVERIFIKASI</span>
                <span className="text-secondary-fixed font-bold">YA • Grade ABCD</span>
              </div>
              <div className="flex justify-between">
                <span className="text-on-primary/50">KADAR MYRISTICIN</span>
                <span className="text-secondary-fixed font-bold">{product.purity}</span>
              </div>
            </div>
          </div>
